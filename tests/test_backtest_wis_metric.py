...
def test_backtest_metrics_csv_includes_wis_when_enabled(monkeypatch, tmp_path) -> None:
    ...
    cfg = {
        ...
        "evaluation": {
            ...
            "wis": {"enabled": True, "intervals": [0.5], "use_latent": False},
            "pit": {"enabled": False},
        },
    ...
    assert header == "variable,horizon,crps,wis,rmse,mae,coverage_50"
